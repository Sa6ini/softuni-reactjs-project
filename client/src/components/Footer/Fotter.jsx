            ...
            <div className="row gx-5">
              <div className="col-lg-4 col-md-12 pt-5 mb-5">
                ...
                <div className="d-flex mt-4">
                  <a
                    ...
                    href="https://www.instagram.com/zaza.felixx/"
                  >
                  ...
                  <a className="btn btn-primary btn-square rounded-circle" href="https://www.instagram.com/zaza.felixx/">
              ...
              <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                ...
                <div className="d-flex flex-column justify-content-start">
                  <Link className="text-secondary mb-2" to="" reloadDocument>
                    <i className="bi bi-arrow-right text-primary me-2" />
                    Home
                  </Link>
                  <Link className="text-secondary mb-2" to="/about" reloadDocument>
                    <i className="bi bi-arrow-right text-primary me-2" />
                    About Us
                  </Link>
                  <Link className="text-secondary mb-2" to="/classes" reloadDocument>
                    <i className="bi bi-arrow-right text-primary me-2" />
                    Class Schedule
                  </Link>
                  <Link className="text-secondary mb-2" to="/trainers" reloadDocument>
                    <i className="bi bi-arrow-right text-primary me-2" />
                    Our Trainers
                  </Link>
                  <Link className="text-secondary" to="/contact" reloadDocument>
                    <i className="bi bi-arrow-right text-primary me-2" />
                    Contact Us
                  </Link>
                </div>
